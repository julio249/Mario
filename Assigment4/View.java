...
class View extends JPanel
{
	...
	public void paintComponent(Graphics g){
		...
		scrollPosition = model.mario.marioX - 100;
		g.setColor(new Color(0,0,0));
		g.fillRect(0, 0, this.getWidth(), this.getHeight());
		
		if(model.mario.rightFacing){
			g.drawImage(model.mario.marios[model.mario.currentImage], model.mario.marioX - scrollPosition, model.mario.marioY, model.mario.w, model.mario.h, null);

		}
		else{
			g.drawImage(model.mario.marios[model.mario.currentImage], model.mario.marioX - scrollPosition + model.mario.w, model.mario.marioY, -model.mario.w, model.mario.h, null);
		...
		// g.drawImage(model.mario.marios[model.mario.currentImage], model.mario.marioX - scrollPosition, model.mario.marioY, null);
